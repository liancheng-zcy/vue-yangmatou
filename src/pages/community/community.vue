      ...
      <div class="community-content">
        ...
        <section class="note-field">
          <div class="waterfall note-waterfall">
            <vue-waterfall-easy :imgsArr="imgsArr" @scrollReachBottom="getData" :mobileGap="10">
              ...
              <div class="img-info" slot-scope="props">
                <div class="note-item">
                  ...
                  <img
                    class
                    src="http://pic1.ymatou.com/G01/M02/7F/18/CgzUCF3UD6qAPY9GAAGl_u_3ONw561_4_3_w_s.jpg"
                    style="opacity: 1;"
                  />
                  <div class="icons buy"></div>
                  </div>-->
...
export default Vue.extend({
  ...
  async mounted() {
    ...
    //   return v.NoteInfo.TagImage[0].Pic
    // })
    // this.imgsArr = img_arr
    // this.group++
  },
  methods: {
    getData() {
